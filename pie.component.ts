...
import { AnalyzerField, DropdownFieldCodename } from '../../../interfaces/ServerModels';
import { yValuesPerXValue, AnalyzerChartIDType } from '../../../interfaces/uiModels';
...
export class PieComponent implements OnInit, OnChanges, AfterViewInit {
    ...
    constructor(private chartConfigService: ChartConfigService, private el: ElementRef) {
    }
